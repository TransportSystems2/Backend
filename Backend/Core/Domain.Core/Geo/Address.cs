namespace TransportSystems.Backend.Core.Domain.Core.Geo
{
    /// <summary>
    /// Ссылка на именование объектов https://tech.yandex.ru/maps/doc/geocoder/desc/reference/kind-docpage/
    /// </summary>
